...
if (is_array($data)) {
			...
			.dragging{
				border: dashed 2px #aaa;
		 		...
		 		<div style="display:flex;animation: appear 1s ease">
		 			...
		 			<div>
		 			<span style="font-size:11px;">kéo và thả một hình ảnh để thay đổi</span><br>
					...
					<form id="myform" >
						...
						<div style="padding: 10px;">
							<br>Gender:<br>
							<input type="radio" value="Male" name="gender" ' . $gender_male . '> Nam<br>
							<input type="radio" value="Female" name="gender" ' . $gender_female . '> Nữ<br>
						</div>
						...
						<input type="button" value="Lưu" id="save_settings_button" onclick="collect_data(event)" ><br>
	...
	$info->message = "Không tìm thấy địa chỉ liên hệ nào";
