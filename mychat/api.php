...
function message_controls()
{
	...
	<span onclick='delete_thread(event)' style='color:purple;cursor:pointer;'>Xóa tất cả cuộc trò chuyện </span>
	<div style='display:flex;width:100%;height:40px;'>
		...
		<input id='message_text' onkeyup='enter_pressed(event)' style='flex:6;border:solid thin #ccc;border-bottom:none;font-size:14px;padding:4px;' type='text' placeHolder='Nhập tin nhắn'/>
		<input style='flex:1;cursor:pointer;' type='button' value='Gửi' onclick='send_message(event)'/>
	</div>
	</div>";
}
