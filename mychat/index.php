    ...
    <div id="wrapper">
        ...
        <div id="left_pannel">
            ...
            <div id="user_info" style="padding: 10px;">
                ...
                <br>
                <span id="username">Tên Tài Khoản</span>
                <br>
                ...
                <br>
                <div>
                    <label id="label_chat" for="radio_chat">Trò chuyện <img src="ui/icons/chat.png"></label>
                    <label id="label_contacts" for="radio_contacts">Liên lạc <img src="ui/icons/contacts.png"></label>
                    <label id="label_settings" for="radio_settings">Cài đặt <img src="ui/icons/settings.png"></label>
                    <label id="logout" for="radio_logout">Đăng xuất <img src="ui/icons/logout.png"></label>
                </div>
...
function logout_user() {
    var answer = confirm("Bạn có chắc chắn bạn muốn thoát??");
    if (answer) {
        get_data({}, "logout");
    }
}
...
function send_message(e) {
    ...
    if (message_text.value.trim() == "") {
        ...
        alert("vui lòng nhập nội dung nào đó để gửi");
        return;
    }
...
function delete_thread(e) {
    ...
    if (confirm("Bạn có chắc chắn muốn xóa toàn bộ  tin nhắn này??")) {
